   ...
   public function uploadHeadLogo(Request $request)
{
    try {
        ...
        $publicPath = Storage::disk('public_html')->path('assets/head_logo');
        ...
        if ($generalConf) {
            ...
            // Move the file to the specified path using Storage
  ...
  public function uploadHomeImage(Request $request)
{
    try {
        ...
        $publicPath = Storage::disk('public_html')->path('assets/imgs_uploads');
  ...
  public function uploadNewCard(Request $request)
{
    try {
        ...
        $base64Filename = base64_encode($filename);
        $publicPath = Storage::disk('public_html')->path('header_cards');
        ...
        // Move the file to the public_html storage
        $file->move($publicPath, $filename);
