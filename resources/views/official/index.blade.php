...
<div id="layoutSidenav_content" style="background-color: rgb(240,236,236);">
  ...
  <div class="nav" style="margin-top: 20px;">
    <ul class="nav nav-tabs" style="background-color: #f8f9fa; border-radius: 8px; padding: 10px;">
        <li class="nav-item">
            <a class="nav-link active " style="color:green; font-weight:bold;" aria-current="page"  href="{{route('official.index')}}"style="color: #333; font-size: 16px;">Barangay Officials  </a>
        </li>
         <li class="nav-item">
            <a class="nav-link " aria-current="page"  href="{{route('SKofficial.index')}}" style="color: #333; font-size: 16px; ">SK Officials</a>
        </li>
    </ul>
</div>
                <div class="d-flex justify-content-end mt-3 mb-4">
                <button class="btn btn-primary"  id="addOfficialBtn">
                        <i class="fas fa-pencil"></i> <i class="fas fa-plus"></i> Add Official
                    </button>
                </div>
