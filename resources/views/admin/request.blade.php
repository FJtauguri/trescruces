...
<script>
    ...
    var table = new Tabulator("#table-container", {
        ...
        columns: [
            { title: "User Email", field: "users", maxWidth: 800 }, 
            { title: "Modified By (Staff Email)", field: "modifiedBy", maxWidth: 800 },
            { title: "Tracking Code", field: "tracking_code", maxWidth: 500 },
            { title: "Status", field: "status", maxWidth: 1500, formatter: function(cell, formatterParams) {
