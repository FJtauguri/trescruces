    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var table = new Tabulator("#reportsTable", {
            ...
            columns: [
                ...
                { title: "Email Address", field: "email",width: 150 },
                { title: "Contact", field: "contact_num",width: 150 },
                { title: "Issue", width: 150, field: "issue", formatter: function(cell) {
                ...
                { title: "Date Filed", field: "created_at",width: 250 },
