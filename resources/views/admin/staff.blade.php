...
<div id="layoutSidenav_content" style="background-color: rgb(240,236,236);">
    <main>
       <div class="container-fluid px-4 mb-4">
          <div class="d">
             <h1 class="mt-4">{{ ucwords(auth()->user()->roles) }} | <span style="font-size:22px;">Registered Staff Accounts List</span></h1>
          </div>
...
var table = new Tabulator("#table-container", {
    ...
    layout: "fitColumns",  // This makes the table's columns fit into the available width
    pagination: "local",
    paginationSize: 10,
    height: "100%",
    width: "100%",
    ...
    columns: [
        { title: "Firstname", field: "Firstname", width: 250 },
        { title: "Lastname", field: "Lastname", width: 250 },
        { title: "Email", field: "Email", width: 250 },
        { title: "Date created", field: "Date created", width: 250 },
        { title: "Action", field: "Action", formatter: "html", colspan: 2, width: 200 },
    ],
});
...
@endsection
@section('title','List of Registered Staff Table')