    ...
    <div id="app">
        ...
        <main class="bodymain" id="bodymain">
            ...
            <div id="innerMain" class="innerMain">
                ...
                <div class="chat-bubble" title="Chat Support" id="chatBubble">
            <i class="fas fa-comments" id="openChat"></i>
            <div class="unread-messages-badge">
    ...
    @if ($errors->any())
        @foreach ($errors->all() as $error)
            toastr.error('{{ $error }}', 'Validation Error', { 
                ...
                "closeButton": true, 
                "progressBar": true,
                "toastClass": "custom-error-toast" // Add a custom class
            });
        @endforeach
    @endif
</script>
