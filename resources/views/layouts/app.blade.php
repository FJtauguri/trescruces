...
<head>
    ...
    <meta property="og:image" style=" border-radius:50%;" content="{{ asset('assets/head_logo/' . ($generalConfig->logo ?? 'default-logo.png')) }}" />
...
<body>
    ...
    <script type="module" src="{{ asset(mix('resources/js/app.js')) }}"></script>

    <script type="module" src="{{ asset(mix('resources/js/listener.js')) }}"></script>
</body>
</html>