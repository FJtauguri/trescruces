...
<div id="layoutSidenav_content" style="background-color: rgb(240,236,236);">
    <main>
        <div class="container-fluid px-4">
            <div class="d">
                <h1 class="mt-4">{{ ucwords(auth()->user()->roles) }} | <span style="font-size:22px;">Registered Resident Account List</span></h1>
            </div>
...
var table = new Tabulator("#table-container", {
    ...
    columns: [
        ...
        { 
            title: "Action", 
            field: "id", // Ensure this field matches the unique ID from your data
            formatter: function (cell, formatterParams) {
                // Create a button with an onClick handler
                return `<button class="btn btn-danger btn-sm delete-btn" onclick="delete_resident(${cell.getValue()})">Delete</button>`;
            },
            hozAlign: "center",
            width: 100 
        },
