                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('adminprofile.update') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center mb-4">
                                <img class="img-fluid rounded-circle" style=" border-radius:50%; width:200px; height:200px;" id="alb-prev-img"  src="{{ asset('profile_pic/' . ($user_photo ?? 'default-avatar.png')) }}" alt="User Photo">
