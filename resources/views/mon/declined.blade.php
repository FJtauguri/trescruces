    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="text-center" style="background-color:rgb(255,255,255,0.4); padding:10px; border-radius:10px;">
                ...
                <span class="action-legend"><b>View request</b> = <button class="btn btn-sm btn-outline-primary"><i class="fa-regular fa-eye"></i></button></span>
                <span class="action-legend"><b>DELETE REQUEST</b> = <button class="btn btn-sm btn-outline-danger"><i class="fa-solid fa-trash-can"></i></button></span>
                <span class="action-legend"><b>Move to Pending</b> = <button class="btn btn-sm btn-outline-warning"><i class="fa-regular fa-clock"></i></button></span>
                <span class="action-legend"><b>Move to Approve</b> = <button class="btn btn-sm btn-outline-success"><i class="fa-solid fa-check"></i></button></span>
            </div>
            <br>
...
<style>
    ...
    /* Add this CSS to make the table scrollable horizontally on mobile */
    @media screen and (max-width: 768px) {
        ...
        /* Make the table wide enough so it can scroll horizontally */
        .tabulator-table {
            min-width: 600px; /* Adjust based on your table width */
        }

        .tabulator-header, .tabulator-table {
            width: 100% !important;
        }
        ...
        /* Style for search input on mobile */
        .search-btn input {
            padding: 10px;
            font-size: 16px;
        }
...
<script>
    ...
    var table = new Tabulator("#table-container", {
        ...
        paginationSize: 4,
        height: "100%",
        // responsiveLayout: "hide", // Hide columns instead of collapsing
        ...
        columns: [
            ...
            { 
                ...
                formatter: function(cell, formatterParams, onRendered){
                    ...
                    return ` 
                        <button  title="View Request" class="btn btn-sm btn-outline-primary" onclick="viewRequest(${id})"><i class="fa-regular fa-eye"></i></button>
                        <button  title="Delete Request" class="btn btn-sm btn-outline-danger" onclick="confirmAction(2, ${id})"><i class="fa-solid fa-trash-can"></i></button>
                        <button  title="Move to Pending Request" class="btn btn-sm btn-outline-warning" onclick="confirmAction(3, ${id})"><i class="fa-regular fa-clock"></i></button>
                        <button  title="Approve Request" class="btn btn-sm btn-outline-success" onclick="confirmAction(4, ${id})"><i class="fa-solid fa-check"></i></button>
                    `;
                },
                minWidth: 200
            }
