...
<div id="layoutSidenav_content" style="background-color: rgb(240,236,236);">
    <main>
        <div class="container-fluid px-4">
            <div class="d">
                <h1 class="mt-4">{{ ucwords(auth()->user()->roles) }} | <span style="font-size:22px;">Pending
                        Requests</span></h1>
            </div>
            ...
            <div class="text-center" style="background-color:rgb(255,255,255,0.4); padding:10px; border-radius:10px;">
                ...
                <span style="background-color:rgb(0,0,0,0.1);" class="btn mx-3 mt-1"><b>View request</b> = <button
                        class="btn btn-sm btn-outline-primary"><i class="fa-regular fa-eye"></i></button></span>
                <span style="background-color:rgb(0,0,0,0.1);" class="btn mx-3 mt-1"><b>Move to Decline</b> = <button
                        class="btn btn-sm btn-outline-danger"><i class="fa-solid fa-x"></i></button></span>
                <span style="background-color:rgb(0,0,0,0.1);" class="btn mx-3 mt-1"><b>Move to Approved</b> = <button
                        class="btn btn-sm btn-outline-success"><i class="fa-solid fa-check"></i></button></span>
            </div>
            <br>
            <div class="shadow search-btn d-flex p-2 rounded" style="background-color:rgb(255,255,255,0.4);">
                <input autofocus onkeyup="search_btn();" onkeydown="if (event.keyCode === 13) search_btn();" type="text"
                    id="search-input" autocomplete="off" placeholder="Search name...">
            </div>
