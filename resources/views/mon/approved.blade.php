            ...
            { 
                ...
                formatter: function(cell, formatterParams, onRendered){
                    ...
                    return `
                        ...
                        <button  title="Decline Request" class="btn btn-sm btn-outline-danger" onclick="confirmAction(2, ${id})"><i class="fa-solid fa-x"></i></button>
                        <button  title="Pending Request" class="btn btn-sm btn-outline-warning" onclick="confirmAction(3, ${id})"><i class="fa-regular fa-clock"></i></button>
                    `;
                },
                minWidth: 150
            }
