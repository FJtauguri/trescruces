            ...
            <div class="mb-3 container row">
                ...
                <div class="col-4 mt-2">
                    <div class="justify-content-center">
                        <label>Primary:</label>
                        <input disabled type="color" class="form-control form-control-color" value="{{ $primaryColor }}" name="theme[primary]" title="Choose a color">
                    </div>
                </div>
                <div class="col-4 mt-2">
                    <div class="justify-content-center">
                        <label>Background:</label>
                        <input disabled  type="color" class="form-control form-control-color" value="{{ $bgColor }}" name="theme[bg]" title="Choose a color">
                    </div>
                </div>
                <div class="col-4 mt-2">
                    <div class="justify-content-center">
