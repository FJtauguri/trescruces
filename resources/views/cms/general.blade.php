...
<div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-3">
                <input ="form-control" hidden autocomplete="off" name="gcash_no" value="{{ $generalConfig->gcash_no }}" placeholder="Ex: 09123123123">
                <label>Max service request per Member </label>
                <input disabled class class="form-control" type="number" value="{{ $generalConfig->max_requests }}" name="service_max_no">
            </div>
            <div class="col-3">
                <label>Fees: </label>
                <input disabled class="form-control" autocomplete="off" name="payment_amt" value="{{ $generalConfig->payment_amt }}" placeholder="Ex: 100">
            </div>
        </div>
        <div class="mt-3 mb-5 mx-1 col-md-2 d-flex justify-content-end" style="float: right;">
            <button type="button"  class="btn btn-primary btn-lg rounded-pill" id="saveGeneralChanges" onclick="save_page_change()" value="">Save changes</button>
        </div>
        </form>
    </div>
            ...
            <div class="row w-100">
                @foreach($homeimgs as $data)
                    ...
                    <section class="m-2 image col-md-4 position-relative d-flex">
                        ...
                        <img class="w-100" src="{{ asset('assets/imgs_uploads/' . $img) }}" alt="Home Image">
                    </section>
                @endforeach
            </div>
        </div>
