                        ...
                        <div class="comment {{ $comment->user_id === auth()->id() ? 'my-comment' : '' }}">
                            ...
                            @if($comment->user_id === auth()->id())
                                <div class="comment-actions">
                                    ...
                                    <button style="color:red;" class="delete-comment" title="Delete Comment"wire:confirm="Are you sure you want to delete this comment?" wire:click="deleteComment({{ $comment->id }})">
