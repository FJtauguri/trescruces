...
<div id="layoutSidenav_content" style="background-color: rgb(240,236,236);">
    <main>
        <div class="container-fluid px-4">
            <div class="d">
                <h1 class="mt-4">{{ ucwords(auth()->user()->roles) }} | <span style="font-size:22px;">Household Records</span></h1>
            </div>
...
<script>
    ...
    var table = new Tabulator("#table-container", {
        ...
        columns: [
            ...
            { title: "Cellphone", field: "cellphone", width: 250 },
            { title: "House Hold Number", field: "household_number", width: 250 },
            { title: "Date Recorded", field: "date_recorded", width: 250 },
