...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const searchCode = urlParams.get('c');

    if (searchCode) { // Check if there's a search input
        @if(isset($data))
            var tableData = [
                {
                    ...
                    "comment": "{{ $data->status === 'declined' ? $data->comment ?? 'No comment provided' : '' }}",
                }
            ];
    ...
    columns: [
        { title: "Fullname", field: "name", width: 200 }, // Set column width
        { title: "Request Type", field: "request_type", width: 150 }, // Set column width
        { title: "Date Requested", field: "date_requested", width: 200 }, // Set column width
        { title: "Comments", field: "comment", width: 250 }, // Set column width
        { 
            title: "Status", 
            field: "status", 
