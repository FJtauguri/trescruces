...
Route::middleware(['auth'])->group(function () {
    ...
    //PRINT 
    Route::get('/print-doc/{id}', [PrintController::class, 'getPrint'])->name('print.get');

    //STAFF DASHBOARD
    Route::get('/staff-dashboard',[StaffController::class,'index'])->name('staff.dashboard');
    Route::get('/staff-settings',[StaffController::class,'staffSettings'])->name('staff.settingss');
    Route::get('/residentslist', [StaffController::class, 'residentList'])->name('staff.resident-lists');
    ...
    //view official
    Route::get('/admin/brgy-officials',[OfficialController::class,'index'])->name('official.index');
    Route::get('/admin/sk-officials',[OfficialController::class,'indexSK'])->name('SKofficial.index');
    Route::post('/save-officials',[OfficialController::class,'store'])->name('official.store');
    Route::post('/save-SKofficials',[OfficialController::class,'storeSK'])->name('SKofficial.store');
    Route::put('/update-official/{id}', [OfficialController::class, 'update']);
    Route::delete('/delete-official/{officialId}', [OfficialController::class, 'destroy']);
    Route::put('/update-SKofficial/{id}', [OfficialController::class, 'updateSK']);
    Route::delete('/delete-SKofficial/{officialId}', [OfficialController::class, 'destroySK']);
    
    Route::get('/view/brgy-officials',[OfficialController::class,'indexRes'])->name('resofficial.index');
    Route::get('/view/sk-officials',[OfficialController::class,'indexSKResident'])->name('resSKofficial.index');
